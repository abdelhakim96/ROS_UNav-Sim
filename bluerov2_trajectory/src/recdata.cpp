...
void dynamicReconfigureCallback(bluerov2_trajectory::set_recdataConfig &config, uint32_t level)
{
...
int main(int argc, char **argv)
{
    ...
    dynamic_reconfigure::Server<bluerov2_trajectory::set_recdataConfig> server;
    dynamic_reconfigure::Server<bluerov2_trajectory::set_recdataConfig>::CallbackType f;
    ...
    string path_dir = ros::package::getPath("bluerov2_trajectory") + "/Exp_data/";
