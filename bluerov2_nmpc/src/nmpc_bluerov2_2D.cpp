...
NMPC_PC::NMPC_PC(struct nmpc_struct_& _nmpc_inp_struct)
{
    ...
    nmpc_cmd_struct.control_wrench_vec.resize(4, 0.0);
    //nmpc_cmd_struct.control_wrench_vec = nmpc_inp_struct.U_ref(3);
                        ...
                        std::vector<double>& statesmeas)
{
    ...
    commandstruct.control_wrench_vec[0] = acadostruct.u[0];
